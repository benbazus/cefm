...
exports.generateUniqueId = exports.formatSize = exports.zipFolder = exports.generateOtp = exports.generateRandomPassword = exports.scanFileWithClamAV = exports.checkFileSignature = exports.isValidFile = void 0;
...
const isValidFile = (file) => {
    ...
    const allowedExtensions = [
        ...
        '.xls', '.xlsx', '.ppt', '.pptx', '.aac',
        '.txt', '.zip', '.mp4', '.mov', '.avi',
        '.mkv', '.webm', '.mp3', '.wav', '.m4a',
        '.ogg'
    ];
    // Allowed MIME types
